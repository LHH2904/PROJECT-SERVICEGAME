        ...
        <div class="container">
            <div class="row">
                <div class="alert alert-info" role="alert">
                    ...
                    <p></p>
                    <p><span style="color:#e74c3c"><strong>Danh mục game Liên Quân . </strong></span><strong>Danh mục game Liên Quân bán skin và tướng giá rẻ </strong></p>
                    <p></p>
                </div>
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            ...
                            <div class="news_title">
                                <h2>
                                    <a href="{{route('danhmuccon', 'nick-lien-quan')}}" title="Danh Mục Game Liên Quân">Danh Mục
                                        Game Liên Quân</a>
                                </h2>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="custom72 view">
                                            <a href="{{route('danhmuccon', 'nick-lien-quan')}}" class=""
