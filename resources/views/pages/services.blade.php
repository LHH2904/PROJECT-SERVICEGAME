                ...
                <div class="row row-flex-safari game-list">
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            <div class="news_image">
                                ...
                                <a href="{{route('dichvucon', 'mua-nick-lien-quan')}}" title="Danh Mục Game Free Fire"
                                    class="">
                                    <img src="{{asset('frontend/images/danhmuc.gif')}}" alt="Danh Mục Game Free Fire"></a>
                            </div>
                            <div class="news_title">
                                <h2>
                                    <a href="{{route('dichvucon', 'mua-nick-lien-quan')}}" title="Danh Mục Game Liên Quân">Danh Mục
                                        Game Liên Quân</a>
                                </h2>
                            </div>
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            ...
                            <div class="news_title">
                                <h2>
                                    <a href="{{route('dichvucon', 'cay-thue-lien-quan')}}" title="Danh Mục Game Free Fire">Danh Mục
                                        Game Free Fire</a>
                                </h2>
                            </div>
                            <div class="news_description">
